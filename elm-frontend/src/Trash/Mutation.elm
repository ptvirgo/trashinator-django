...
saveTrash fillInOptionals requiredArgs object =
    ...
    in
    Object.selectionField "saveTrash" (optionalArgs ++ [ Argument.required "date" requiredArgs.date (\(Trash.Scalar.Date raw) -> Encode.string raw), Argument.required "token" requiredArgs.token Encode.string ]) object (identity >> Decode.nullable)
