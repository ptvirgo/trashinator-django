...
var _user$project$TrashPage_Model$trash = A2(
	...
	A2(
		_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
		_user$project$Trash_Object_TrashNode$gallons,
		A2(
			_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
			...
			A3(
				...
				function (opts) {
					return _elm_lang$core$Native_Utils.update(
						opts,
						{
							metric: _dillonkearns$graphqelm$Graphqelm_OptionalArgument$Present(metric),
							volume: volume
						});
				},
				{
		...
		if (_p3.ctor === 'Err') {
			...
			if (_p4.ctor === 'Nothing') {
				return _elm_lang$core$Native_Utils.update(
					...
					{
						volume: _elm_lang$core$Maybe$Nothing,
						error: _elm_lang$core$Maybe$Just('Failed to save!')
					});
			} else {
				return _elm_lang$core$Native_Utils.update(
					model,
