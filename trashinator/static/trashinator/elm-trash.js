...
var _user$project$Models$Trash = F2(
	function (a, b) {
		return {date: a, amount: b};
	});
var _user$project$Models$TrashPage = F3(
	function (a, b, c) {
		return {trash: a, error: b, token: c};
	});
var _user$project$Models$Litres = function (a) {
	return {ctor: 'Litres', _0: a};
};
var _user$project$Models$Gallons = function (a) {
	return {ctor: 'Gallons', _0: a};
};
var _user$project$Models$emptyTrash = {
	date: _elm_lang$core$Date$fromTime(0),
	amount: _user$project$Models$Gallons(0)
};

var _user$project$UpdateTrashPage$nodeToTrash = function (node) {
	var date = A2(
		_elm_lang$core$Result$withDefault,
		_elm_lang$core$Date$fromTime(0),
		_elm_lang$core$Date$fromString(node.date));
	var amount = function () {
		var _p0 = node.gallons;
		if (_p0.ctor === 'Just') {
			return _user$project$Models$Gallons(_p0._0);
		} else {
			return _user$project$Models$Litres(
				A2(_elm_lang$core$Maybe$withDefault, 0, node.litres));
		}
	}();
	return A2(_user$project$Models$Trash, date, amount);
};
var _user$project$UpdateTrashPage$newError = F2(
	function (err, page) {
		return _elm_lang$core$Native_Utils.update(
			page,
			{
				error: _elm_lang$core$Maybe$Just(err)
			});
	});
var _user$project$UpdateTrashPage$newTrash = F2(
	function (trash, page) {
		return _elm_lang$core$Native_Utils.update(
			page,
			{
				trash: _elm_lang$core$Maybe$Just(trash),
				error: _elm_lang$core$Maybe$Nothing
			});
	});
var _user$project$UpdateTrashPage$setAmount = F2(
	function (x, trash) {
		var _p1 = trash.amount;
		if (_p1.ctor === 'Litres') {
			return _elm_lang$core$Native_Utils.update(
				trash,
				{
					amount: _user$project$Models$Litres(x)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				trash,
				{
					amount: _user$project$Models$Gallons(x)
				});
		}
	});
var _user$project$UpdateTrashPage$changeAmount = F2(
	function (txt, page) {
		var _p2 = _elm_lang$core$String$toFloat(txt);
		if (_p2.ctor === 'Err') {
			return _elm_lang$core$Native_Utils.update(
				page,
				{
			...
			var _p3 = _p2._0;
			return (_elm_lang$core$Native_Utils.cmp(_p3, 0) < 0) ? _elm_lang$core$Native_Utils.update(
				page,
				{
				...
				page,
				{
					error: _elm_lang$core$Maybe$Just('... remember to save your changes!'),
					trash: _elm_lang$core$Maybe$Just(
						A2(
							_user$project$UpdateTrashPage$setAmount,
							_p3,
							A2(_elm_lang$core$Maybe$withDefault, _user$project$Models$emptyTrash, page.trash)))
				});
		}
	});
var _user$project$UpdateTrashPage$updateTrashPage = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'ChangeAmount':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$UpdateTrashPage$changeAmount, _p4._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NewTrash':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$UpdateTrashPage$newTrash, _p4._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$UpdateTrashPage$newError, _p4._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$UpdateTrashPage$TrashInput = F4(
	function (a, b, c, d) {
		return {token: a, date: b, gallons: c, litres: d};
	});
var _user$project$UpdateTrashPage$TrashNode = F3(
	function (a, b, c) {
		return {date: a, gallons: b, litres: c};
	});
var _user$project$UpdateTrashPage$saveTrashGQL = function () {
	var trashNode = A2(
		...
		A3(
			...
			'litres',
			{ctor: '[]'},
			_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$nullable(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$float)),
		A2(
			_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$with,
			A3(
				_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$field,
			...
			A2(
				...
				_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$object(_user$project$UpdateTrashPage$TrashNode))));
	var litres = A3(
		...
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$nullable(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$float));
	var gallons = A3(
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$required,
		'gallons',
		function (_) {
	...
	var token = A3(
		...
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$string);
	var mutationRoot = _jamesmacaulay$elm_graphql$GraphQL_Request_Builder$extract(
		A3(
			_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$field,
			'saveTrash',
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'token',
					_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(token)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'date',
						_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(date)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'gallons',
							_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(gallons)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'litres',
								_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(litres)
							},
							_1: {ctor: '[]'}
						}
					}
			...
			trashNode));
	return _jamesmacaulay$elm_graphql$GraphQL_Request_Builder$mutationDocument(mutationRoot);
}();
var _user$project$UpdateTrashPage$NewError = function (a) {
	return {ctor: 'NewError', _0: a};
};
var _user$project$UpdateTrashPage$NewTrash = function (a) {
	return {ctor: 'NewTrash', _0: a};
};
var _user$project$UpdateTrashPage$recieveTrashNode = function (result) {
	var _p5 = result;
	if (_p5.ctor === 'Err') {
		if (_p5._0.ctor === 'HttpError') {
			return _user$project$UpdateTrashPage$NewError(
		...
		return _user$project$UpdateTrashPage$NewTrash(
			_user$project$UpdateTrashPage$nodeToTrash(_p5._0));
	}
};
var _user$project$UpdateTrashPage$saveTrash = F2(
	function (token, trash) {
		var dateString = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Date$year(trash.date)),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'-',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
						_elm_lang$core$Date$month(trash.date)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'-',
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Date$day(trash.date))))));
		var emptyInput = {token: token, date: dateString, gallons: _elm_lang$core$Maybe$Nothing, litres: _elm_lang$core$Maybe$Nothing};
		var input = function () {
			var _p6 = trash.amount;
			if (_p6.ctor === 'Gallons') {
				return _elm_lang$core$Native_Utils.update(
					emptyInput,
					{
						gallons: _elm_lang$core$Maybe$Just(_p6._0)
					});
			} else {
				return _elm_lang$core$Native_Utils.update(
					emptyInput,
					{
						litres: _elm_lang$core$Maybe$Just(_p6._0)
					});
			}
		}();
		return A2(
			_elm_lang$core$Task$attempt,
			_user$project$UpdateTrashPage$recieveTrashNode,
			A2(
				_jamesmacaulay$elm_graphql$GraphQL_Client_Http$sendMutation,
				'/graphql/?',
				A2(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$request, input, _user$project$UpdateTrashPage$saveTrashGQL)));
	});
var _user$project$UpdateTrashPage$ChangeAmount = function (a) {
	return {ctor: 'ChangeAmount', _0: a};
};

var _user$project$ViewTrashPage$amountVolume = function (amt) {
	var _p0 = amt;
	if (_p0.ctor === 'Gallons') {
		return _p0._0;
	} else {
...
var _user$project$ViewTrashPage$amountWord = function (amt) {
	var _p1 = amt;
	if (_p1.ctor === 'Gallons') {
		return 'gallon';
	} else {
...
var _user$project$ViewTrashPage$sayAmount = function (amt) {
	var x = function () {
		var _p2 = amt;
		if (_p2.ctor === 'Gallons') {
			return _p2._0;
	...
	var measure = _user$project$ViewTrashPage$amountWord(amt);
	return _elm_lang$core$Native_Utils.eq(x, 0) ? 'nothing' : (_elm_lang$core$Native_Utils.eq(x, 1) ? A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(x),
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			A2(_elm_lang$core$Basics_ops['++'], measure, ' of trash'))) : A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(x),
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				measure,
				A2(_elm_lang$core$Basics_ops['++'], 's', ' of trash')))));
};
var _user$project$ViewTrashPage$viewError = function (errState) {
	var _p3 = errState;
	if (_p3.ctor === 'Nothing') {
...
var _user$project$ViewTrashPage$viewTrash = function (trashState) {
	var _p4 = trashState;
	if (_p4.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$p,
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_user$project$ViewTrashPage$sayAmount(_p5.amount),
									' today.'))),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('inputTrashAmount'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_0: _elm_lang$html$Html_Attributes$placeholder(
										_elm_lang$core$Basics$toString(
											_user$project$ViewTrashPage$amountVolume(_p5.amount))),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$UpdateTrashPage$ChangeAmount),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_user$project$ViewTrashPage$amountWord(_p5.amount),
											's of trash'))),
								_1: {ctor: '[]'}
							}
						}),
...
var _user$project$ViewTrashPage$viewTrashPage = function (page) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('trashPage'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$ViewTrashPage$viewTrash(page.trash),
			_1: {
				ctor: '::',
				_0: _user$project$ViewTrashPage$viewError(page.error),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$TrashPageMain$importArgs = function (flags) {
	var amount = function () {
		var _p0 = flags.metric;
		if (_p0 === 'litres') {
			return _user$project$Models$Litres(0);
		} else {
			return _user$project$Models$Gallons(0);
		}
	}();
	return {
		token: flags.token,
		...
		trash: _elm_lang$core$Maybe$Just(
			{
				date: _elm_lang$core$Date$fromTime(flags.timeStamp),
				amount: amount
			})
	};
};
var _user$project$TrashPageMain$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (flags) {
			return {
				ctor: '_Tuple2',
				_0: _user$project$TrashPageMain$importArgs(flags),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		},
		view: _user$project$ViewTrashPage$viewTrashPage,
		update: _user$project$UpdateTrashPage$updateTrashPage,
...
var _user$project$TrashPageMain$Flags = F3(
	function (a, b, c) {
		return {token: a, timeStamp: b, metric: c};
	});

var Elm = {};
Elm['TrashPageMain'] = Elm['TrashPageMain'] || {};
if (typeof _user$project$TrashPageMain$main !== 'undefined') {
    _user$project$TrashPageMain$main(Elm['TrashPageMain'], 'TrashPageMain', undefined);
}
