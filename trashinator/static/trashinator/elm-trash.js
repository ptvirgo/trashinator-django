...
var _user$project$Trash_Enum_Metric$toString = function ($enum) {
	var _p0 = $enum;
	if (_p0.ctor === 'Gallons') {
		return 'Gallons';
	} else {
...
var _user$project$Trash_Enum_Metric$Litres = {ctor: 'Litres'};
var _user$project$Trash_Enum_Metric$Gallons = {ctor: 'Gallons'};
var _user$project$Trash_Enum_Metric$decoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (string) {
		var _p1 = string;
		switch (_p1) {
			case 'Gallons':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Trash_Enum_Metric$Gallons);
			case 'Litres':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Trash_Enum_Metric$Litres);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Trash_Object_SiteStatsNode$gallonsStandardDeviation = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'gallonsStandardDeviation',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$gallonsPerPersonPerWeek = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'gallonsPerPersonPerWeek',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$litresStandardDeviation = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'litresStandardDeviation',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$litresPerPersonPerWeek = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'litresPerPersonPerWeek',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$volumeStandardDeviation = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'VolumeStandardDeviation',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$volumePerPersonPerWeek = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'VolumePerPersonPerWeek',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_SiteStatsNode$id = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'id',
	{ctor: '[]'},
	A2(
...
var _user$project$Trash_Object_SiteStatsNode$selection = function (constructor) {
	return _dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$selection(constructor);
};

var _user$project$Trash_Object_StatsNode$user = function (object) {
	return A4(
		_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$selectionField,
		'user',
		{ctor: '[]'},
...
var _user$project$Trash_Object_StatsNode$site = function (object) {
	return A4(
		_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$selectionField,
		'site',
		{ctor: '[]'},
...
var _user$project$Trash_Object_TrashNode$gallons = A3(
	...
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_TrashNode$litres = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'litres',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_TrashNode$date = A3(
	...
	A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$Trash_Scalar$Date,
		_elm_lang$core$Json_Decode$oneOf(
			{
				ctor: '::',
				_0: _elm_lang$core$Json_Decode$string,
...
var _user$project$Trash_Object_TrashNode$selection = function (constructor) {
	return _dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$selection(constructor);
};

var _user$project$Trash_Object_UserStatsNode$gallonsPerPersonPerWeek = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'gallonsPerPersonPerWeek',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_UserStatsNode$litresPerPersonPerWeek = A3(
	_dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$fieldDecoder,
	'litresPerPersonPerWeek',
	{ctor: '[]'},
	_elm_lang$core$Json_Decode$float);
var _user$project$Trash_Object_UserStatsNode$selection = function (constructor) {
	return _dillonkearns$graphqelm$Graphqelm_Internal_Builder_Object$selection(constructor);
};
...
var _user$project$TrashPage_Model$setPageDay = F2(
	function (day, page) {
		var oldOpts = page.opts;
		var newOpts = _elm_lang$core$Native_Utils.update(
			oldOpts,
			{day: day});
		return _elm_lang$core$Native_Utils.update(
			page,
...
var _user$project$TrashPage_Model$setPageChanged = F2(
...
var _user$project$TrashPage_Model$setPageError = F2(
	function (err, page) {
		var oldMeta = page.meta;
		var newMeta = _elm_lang$core$Native_Utils.update(
			oldMeta,
...
var _user$project$TrashPage_Model$setPageVolume = F2(
	function (vol, page) {
		var oldEntry = page.entry;
		var newEntry = _elm_lang$core$Native_Utils.update(
			oldEntry,
			{volume: vol});
		return _elm_lang$core$Native_Utils.update(
			page,
...
var _user$project$TrashPage_Model$relativeDate = F2(
	function (ts, whichDay) {
		var timestamp = function () {
			...
			switch (_p1.ctor) {
				case 'Today':
					return ts;
				case 'Yesterday':
					return ts - (24 * _elm_lang$core$Time$hour);
				default:
					return ts - (48 * _elm_lang$core$Time$hour);
			}
		}();
		var elmDate = _elm_lang$core$Date$fromTime(timestamp);
		var year = _elm_lang$core$Basics$toString(
			_elm_lang$core$Date$year(elmDate));
		var day = A3(
			_elm_lang$core$String$padLeft,
			2,
			_elm_lang$core$Native_Utils.chr('0'),
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Date$day(elmDate)));
		var monthString = function (d) {
			var _p2 = _elm_lang$core$Date$month(d);
			switch (_p2.ctor) {
				case 'Jan':
					return '01';
				case 'Feb':
		...
		var month = monthString(elmDate);
		return _user$project$Trash_Scalar$Date(
			A2(
				_elm_lang$core$Basics_ops['++'],
				year,
				A2(
...
var _user$project$TrashPage_Model$TPMeta = F3(
	function (a, b, c) {
		return {timestamp: a, error: b, changed: c};
	});
var _user$project$TrashPage_Model$TPOptions = function (a) {
	return {day: a};
};
var _user$project$TrashPage_Model$TPEntry = F4(
	function (a, b, c, d) {
		return {jwt: a, date: b, metric: c, volume: d};
	});
var _user$project$TrashPage_Model$TPStats = F3(
	function (a, b, c) {
		return {sitePerPersonPerWeek: a, siteStandardDeviation: b, userPerPersonPerWeek: c};
	});
var _user$project$TrashPage_Model$TrashPage = F4(
	function (a, b, c, d) {
		return {meta: a, opts: b, entry: c, stats: d};
	});
var _user$project$TrashPage_Model$GqlTrash = function (a) {
	return {volume: a};
};
var _user$project$TrashPage_Model$parseTrash = function (metric) {
	var field = function () {
		var _p4 = metric;
		if (_p4.ctor === 'Gallons') {
			return _user$project$Trash_Object_TrashNode$gallons;
		} else {
			return _user$project$Trash_Object_TrashNode$litres;
		}
	}();
	return A2(
		_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
		field,
		_user$project$Trash_Object_TrashNode$selection(_user$project$TrashPage_Model$GqlTrash));
};
var _user$project$TrashPage_Model$parseSaveTrash = function (metric) {
	return A2(
		_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
		_user$project$Trash_Object_SaveTrash$trash(
			_user$project$TrashPage_Model$parseTrash(metric)),
		_user$project$Trash_Object_SaveTrash$selection(_elm_lang$core$Basics$identity));
};
var _user$project$TrashPage_Model$GqlUserStats = function (a) {
	return {perPersonPerWeek: a};
};
var _user$project$TrashPage_Model$parseUserStats = function (metric) {
	var field = function () {
		var _p5 = metric;
		if (_p5.ctor === 'Gallons') {
			return _user$project$Trash_Object_UserStatsNode$gallonsPerPersonPerWeek;
		} else {
			return _user$project$Trash_Object_UserStatsNode$litresPerPersonPerWeek;
		}
	}();
	return A2(
		_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
		field,
		_user$project$Trash_Object_UserStatsNode$selection(_user$project$TrashPage_Model$GqlUserStats));
};
var _user$project$TrashPage_Model$GqlSiteStats = F2(
	function (a, b) {
		return {perPersonPerWeek: a, standardDeviation: b};
	});
var _user$project$TrashPage_Model$parseSiteStats = function (metric) {
	var _p6 = function () {
		var _p7 = metric;
		if (_p7.ctor === 'Gallons') {
			return {ctor: '_Tuple2', _0: _user$project$Trash_Object_SiteStatsNode$gallonsStandardDeviation, _1: _user$project$Trash_Object_SiteStatsNode$gallonsPerPersonPerWeek};
		} else {
			return {ctor: '_Tuple2', _0: _user$project$Trash_Object_SiteStatsNode$litresStandardDeviation, _1: _user$project$Trash_Object_SiteStatsNode$litresPerPersonPerWeek};
		}
	}();
	var devField = _p6._0;
	var volField = _p6._1;
...
var _user$project$TrashPage_Model$GqlPageStats = F2(
	function (a, b) {
		return {user: a, site: b};
	});
var _user$project$TrashPage_Model$parsePageStats = function (metric) {
	return A2(
		_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
		_user$project$Trash_Object_StatsNode$site(
			_user$project$TrashPage_Model$parseSiteStats(metric)),
		A2(
			_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
			_user$project$Trash_Object_StatsNode$user(
				_user$project$TrashPage_Model$parseUserStats(metric)),
			_user$project$Trash_Object_StatsNode$selection(_user$project$TrashPage_Model$GqlPageStats)));
};
...
var _user$project$TrashPage_Model$emptyPage = {
	meta: {timestamp: 0, error: _elm_lang$core$Maybe$Nothing, changed: false},
	opts: {day: _user$project$TrashPage_Model$Today},
	entry: {
		jwt: _user$project$TrashPage_Model$Jwt('invalid token'),
		date: A2(_user$project$TrashPage_Model$relativeDate, 0, _user$project$TrashPage_Model$Today),
		metric: _user$project$Trash_Enum_Metric$Gallons,
		volume: _elm_lang$core$Maybe$Nothing
	},
	stats: {sitePerPersonPerWeek: 0, siteStandardDeviation: 0, userPerPersonPerWeek: 0}
};
var _user$project$TrashPage_Model$StatsData = function (a) {
	return {ctor: 'StatsData', _0: a};
};
var _user$project$TrashPage_Model$TrashData = function (a) {
	return {ctor: 'TrashData', _0: a};
};

var _user$project$TrashPage_Update$optionFor = function (a) {
	var _p0 = a;
	if (_p0.ctor === 'Nothing') {
		return _dillonkearns$graphqelm$Graphqelm_OptionalArgument$Absent;
	} else {
...
var _user$project$TrashPage_Update$gotGqlResponse = F2(
	function (gqlResponse, model) {
		var _p2 = gqlResponse;
		if (_p2.ctor === 'TrashData') {
			var _p3 = _p2._0;
			if (_p3.ctor === 'Nothing') {
				return A2(
					_user$project$TrashPage_Model$setPageChanged,
					false,
					A2(
						_user$project$TrashPage_Model$setPageError,
						_elm_lang$core$Maybe$Nothing,
						A2(_user$project$TrashPage_Model$setPageVolume, _elm_lang$core$Maybe$Nothing, model)));
			} else {
				return A2(
					_user$project$TrashPage_Model$setPageChanged,
					false,
					A2(
						...
						A2(
							...
							_elm_lang$core$Maybe$Just(_p3._0.volume),
							model)));
			}
		} else {
			var _p4 = _p2._0;
			var oldStats = model.stats;
			var newStats = _elm_lang$core$Native_Utils.update(
				oldStats,
				{sitePerPersonPerWeek: _p4.site.perPersonPerWeek, siteStandardDeviation: _p4.site.standardDeviation, userPerPersonPerWeek: _p4.user.perPersonPerWeek});
			return _elm_lang$core$Native_Utils.update(
				model,
				{stats: newStats});
		}
	});
var _user$project$TrashPage_Update$gotResponse = F2(
	function (r, model) {
		var _p5 = r;
		if (_p5.ctor === 'Err') {
			return A2(
				...
				A2(_user$project$TrashPage_Model$setPageChanged, false, model));
		} else {
			return A2(_user$project$TrashPage_Update$gotGqlResponse, _p5._0, model);
		}
	});
var _user$project$TrashPage_Update$changeVolume = F2(
	function (txt, model) {
		if (_elm_lang$core$Native_Utils.eq(txt, '')) {
			return A2(
				_user$project$TrashPage_Model$setPageChanged,
				false,
				A2(
			...
			var _p6 = _elm_lang$core$String$toFloat(txt);
			if (_p6.ctor === 'Err') {
				return A2(
					_user$project$TrashPage_Model$setPageChanged,
					true,
					A2(
						_user$project$TrashPage_Model$setPageError,
						_elm_lang$core$Maybe$Just('Amount must be a number'),
						A2(_user$project$TrashPage_Model$setPageVolume, _elm_lang$core$Maybe$Nothing, model)));
			} else {
				var _p7 = _p6._0;
				return (_elm_lang$core$Native_Utils.cmp(_p7, 0) < 0) ? A2(
					...
					A2(
						_user$project$TrashPage_Model$setPageError,
						_elm_lang$core$Maybe$Just('Amount must be 0 or more'),
						A2(_user$project$TrashPage_Model$setPageVolume, _elm_lang$core$Maybe$Nothing, model))) : A2(
					_user$project$TrashPage_Model$setPageChanged,
					true,
					A2(
						_user$project$TrashPage_Model$setPageError,
...
var _user$project$TrashPage_Update$SaveZero = {ctor: 'SaveZero'};
var _user$project$TrashPage_Update$Save = {ctor: 'Save'};
var _user$project$TrashPage_Update$GotResponse = function (a) {
	return {ctor: 'GotResponse', _0: a};
};
var _user$project$TrashPage_Update$lookupTrash = function (model) {
	return A2(
		_dillonkearns$graphqelm$Graphqelm_Http$send,
		_user$project$TrashPage_Update$GotResponse,
		A2(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					_user$project$TrashPage_Model$parsePageStats(model.entry.metric)),
				_user$project$Trash_Query$selection(_user$project$TrashPage_Model$StatsData))));
};
var _user$project$TrashPage_Update$saveTrash = function (model) {
	return A2(
		_dillonkearns$graphqelm$Graphqelm_Http$send,
		_user$project$TrashPage_Update$GotResponse,
		A2(
			...
			A2(
				_dillonkearns$graphqelm$Graphqelm_SelectionSet$with,
				A3(
					_user$project$Trash_Mutation$saveTrash,
					function (opts) {
						return _elm_lang$core$Native_Utils.update(
							opts,
							{
								metric: _dillonkearns$graphqelm$Graphqelm_OptionalArgument$Present(model.entry.metric),
								volume: _user$project$TrashPage_Update$optionFor(model.entry.volume)
							});
					},
					{
						date: model.entry.date,
				...
				_user$project$Trash_Mutation$selection(_user$project$TrashPage_Model$TrashData))));
};
var _user$project$TrashPage_Update$saveZero = function (model) {
	var zero = A2(_user$project$TrashPage_Update$changeVolume, '0', model);
	return {
		ctor: '_Tuple2',
		_0: zero,
		_1: _user$project$TrashPage_Update$saveTrash(zero)
	};
};
	...
	function (msg, model) {
		...
		switch (_p8.ctor) {
			case 'ChangeVolume':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$TrashPage_Update$changeVolume, _p8._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GotResponse':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$TrashPage_Update$gotResponse, _p8._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Save':
				return {
...
var _user$project$TrashPage_View$viewStats = F2(
	function (metric, stats) {
		var userRatio = stats.userPerPersonPerWeek / (stats.sitePerPersonPerWeek * 2);
		var ratioWidth = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(
				A2(_elm_lang$core$Basics$min, userRatio * 30, 30)),
			'ex');
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$id('statsImage'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width('32ex'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$height('3em'),
								_1: {ctor: '[]'}
							}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('#e3dbdb'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$width('30ex'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$height('2em'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$x('1ex'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$y('.5em'),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$rx('3pt'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$ry('3pt'),
														_1: {ctor: '[]'}
													}
												}
											}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill('#6c6753'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$stroke('none'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$width(ratioWidth),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$height('2em'),
												_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fill('#5aa02c'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$stroke('none'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$width('1ex'),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$height('2em'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$x('16ex'),
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$y('.5em'),
															_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										_elm_lang$svg$Svg$rect,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$stroke('#aca793'),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$strokeWidth('3pt'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$width('30ex'),
														_1: {
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(stats.userPerPersonPerWeek),
												A2(
													_elm_lang$core$Basics_ops['++'],
													' ',
													A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(stats.sitePerPersonPerWeek),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' ',
														A2(
...
var _user$project$TrashPage_View$inputVolume = function (entry) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('inputVolume'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$TrashPage_Update$ChangeVolume),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$TrashPage_View$inputZero = function (opts) {
	return A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('inputZero'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$TrashPage_Update$SaveZero),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Nothing ',
					_user$project$TrashPage_Model$whichDayToString(opts.day))),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$TrashPage_View$saveButton = F2(
	function (meta, entry) {
		return (meta.changed && (_elm_lang$core$Native_Utils.eq(meta.error, _elm_lang$core$Maybe$Nothing) && (!_elm_lang$core$Native_Utils.eq(entry.volume, _elm_lang$core$Maybe$Nothing)))) ? A2(
			_elm_lang$html$Html$img,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$TrashPage_Update$Save),
				_1: {
					ctor: '::',
...
var _user$project$TrashPage_Main$init = function (flags) {
	var emptyEntry = _user$project$TrashPage_Model$emptyPage.entry;
	var emptyMeta = _user$project$TrashPage_Model$emptyPage.meta;
	...
	var newPage = _elm_lang$core$Native_Utils.update(
		_user$project$TrashPage_Model$emptyPage,
		{
			...
			entry: _elm_lang$core$Native_Utils.update(
				emptyEntry,
				{
					jwt: _user$project$TrashPage_Model$Jwt(flags.token),
					metric: readMetric(flags.metric),
					date: A2(_user$project$TrashPage_Model$relativeDate, flags.timestamp, _user$project$TrashPage_Model$Today)
				})
		});
	return {
		ctor: '_Tuple2',
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _user$project$TrashPage_Update$lookupTrash(newPage),
				_1: {
					ctor: '::',
					_0: _user$project$TrashPage_Update$lookupStats(newPage),
					_1: {ctor: '[]'}
				}
			})
	};
					...
					return A2(
						...
						function (token) {
							return _elm_lang$core$Json_Decode$succeed(
								{metric: metric, timestamp: timestamp, token: token});
						},
